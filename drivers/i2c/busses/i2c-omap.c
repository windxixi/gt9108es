...
static int omap_i2c_reg_dump(struct omap_i2c_dev *dev)
{
    int i=0;
    printk("[omap_i2c_reg_dump] from OMAP_I2C_REV_REG to OMAP_I2C_IRQENABLE_CLR\n");
    for(i=OMAP_I2C_REV_REG; i<=OMAP_I2C_IRQENABLE_CLR; i++)
        printk("0x%x ", omap_i2c_read_reg(dev, i));
    printk("\n[omap_i2c_reg_dump] end\n"); 
}
