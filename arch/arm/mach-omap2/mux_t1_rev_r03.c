...
#else
        SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_MIPI_HSI_CP_ON, 0)
        SEC_OMAP_OUTPUT_GPIO(OMAP_GPIO_CHG_EN, 1)
...
#else
	OMAP4_MUX(GPMC_AD15, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
#endif   
...
#else
	OMAP4_MUX(GPMC_NCS0, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN),
#endif
...
#else	
	OMAP4_MUX(SIM_RESET, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN),
#endif	
