...
static struct omap_board_mux __omap_board_core_mux[] __initdata = {
	...
	OMAP4_MUX(GPMC_AD11, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT | OMAP_PULL_ENA),
...
#else
	OMAP4_MUX(GPMC_NCS0, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
#endif
...
#else
	OMAP4_MUX(GPMC_NCS2, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
#endif
...
#else
	OMAP4_MUX(GPMC_NADV_ALE, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
#endif
	...
	OMAP4_MUX(USBB1_ULPITLL_DAT0, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
...
#else
	/* [IN---] usbb1_ulpitll_clk - gpio_84 - AP_CP_MRDY */
	OMAP4_MUX(USBB1_ULPITLL_CLK, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
	/* [IN---] usbb1_ulpitll_stp - gpio_85 - NC*/
	OMAP4_MUX(USBB1_ULPITLL_STP, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
	/* [IN---] usbb1_ulpitll_dir - gpio_86 - AP_CP_SRDY */
	OMAP4_MUX(USBB1_ULPITLL_DIR, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	/* [--OUT] usbb1_ulpitll_nxt - gpio_87 -NC */
	OMAP4_MUX(USBB1_ULPITLL_NXT, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
	/* [--OUT] usbb1_ulpitll_dat0 - gpio_88 - AP_CP_INT1 */
	OMAP4_MUX(USBB1_ULPITLL_DAT0, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
	/* [--OUT] usbb1_ulpitll_dat1 - gpio_89 - AP_CP_INT2  */
	OMAP4_MUX(USBB1_ULPITLL_DAT1, OMAP_MUX_MODE3| OMAP_PIN_OUTPUT),
	/* [--OUT] usbb1_ulpitll_dat2 - gpio_90 - MIPI_HSI_RX_FLG */
	OMAP4_MUX(USBB1_ULPITLL_DAT2, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
	/* [IN---] usbb1_ulpitll_dat3 - gpio_91 - MIPI_HSI_RX_RDY */
	OMAP4_MUX(USBB1_ULPITLL_DAT3, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
#endif
	...
	/* [-N-C-] mcspi1_somi - gpio_135 - NC */
	OMAP4_MUX(MCSPI1_SOMI, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLDOWN),
	/* [-N-C-] mcspi1_simo - gpio_136 - NC */
	OMAP4_MUX(MCSPI1_SIMO, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP),
	/* [-N-C-] mcspi1_cs0 - gpio_137 - NC */
	OMAP4_MUX(MCSPI1_CS0, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
#endif
...
#else
	OMAP4_MUX(KPD_COL3, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
#endif
...
#else	
	OMAP4_MUX(SIM_RESET, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
#endif
