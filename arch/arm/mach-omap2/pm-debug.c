...
DEFINE_SIMPLE_ATTRIBUTE(pm_dbg_twl_reg_dump_fops, pad_pmic_reg_get, NULL, "%llu\n");
#endif
...
#ifdef PAD_DEBUGGING
{
	(void) debugfs_create_file("twl_reg_dump", 0664, d,
				   &twl_reg_dump, &pm_dbg_twl_reg_dump_fops);
}
#endif
	pm_dbg_main_dir = d;
	pm_dbg_init_done = 1;
