...
static struct omap_board_mux __omap_board_core_mux[] __initdata = {
	...
	/* [--OUT] gpmc_ncs2 - gpio_52 - GPS_CNTL - CP_DUMP_INT(Rev0.1)*/
	OMAP4_MUX(GPMC_NCS2, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	...
	OMAP4_MUX(USBB1_ULPITLL_DIR, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	...
	OMAP4_MUX(USBB1_ULPITLL_DAT0, OMAP_MUX_MODE3 | OMAP_PIN_INPUT),
	/* [--OUT] usbb1_ulpitll_dat1 - gpio_89 - MIPI_HSI_RX_DATA */
	OMAP4_MUX(USBB1_ULPITLL_DAT1, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
	...
	OMAP4_MUX(USBB1_ULPITLL_DAT3, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	...
	/* [-N-C-] kpd_col2 - gpio_1 - CP_DUMP_INT(Rev0.2) */
	OMAP4_MUX(KPD_COL2, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
...
static struct omap_board_mux __omap_board_wk_mux[] __initdata = {
	...
	OMAP4_MUX(SIM_CLK, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
